...
Internal u16
Absolute_Address(u8 low, u8 high)
{
...
Internal u8
Get_Data(u8* opcodeAddr, b6502* cpu, Instruction instruction)
{
	u8 result = 0;
...
Internal void
Set_Data(u8 byte, u8* opcodeAddr, b6502* cpu, Instruction instruction)
{
	switch(instruction.Mode)
	{
	case Accumulator:
